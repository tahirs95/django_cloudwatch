"""
Django settings for awstask project.
...
SECRET_KEY = 'django-insecure--$!j_m+%1i*=#itrza#1wo((c_fwxh-eb_1t25_^vw!-*pt3j#'
...
WSGI_APPLICATION = 'awstask.wsgi.application'
